...
knitr::include_graphics("figrue/AML_pdent.png")
```
...
```{r,eval=TRUE,echo=FALSE,fig.align='center',out.width="70%"}
knitr::include_graphics("figrue/AML-PE_dotplot.png")
```
...
knitr::include_graphics("figrue/AML-DA_score.png")
```
...
```{r,eval=TRUE,echo=FALSE,fig.align='center'}
knitr::include_graphics("figrue/AML-ESEA_barplot.png")
```
...
```{r,eval=TRUE,echo=FALSE,fig.align='center',out.width="70%"}
knitr::include_graphics("figrue/TNBC-net.png")
```
...
```{r,eval=TRUE,echo=FALSE,fig.align='center'}
knitr::include_graphics("figrue/TNBC-ePEA.png")
```
...
```{r,eval=TRUE,echo=FALSE,fig.align='center'}
knitr::include_graphics("figrue/TNBC-ePDA.png")
```
...
```{r,eval=TRUE,echo=FALSE,fig.align='center'}
knitr::include_graphics("figrue/TNBC-eSEA.png")
```
...
```{r,eval=TRUE,echo=FALSE,fig.align='center'}
knitr::include_graphics("figrue/Spatial.png")
```
