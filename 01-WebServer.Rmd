...
knitr::include_graphics("figrue/1.net.png")
```
...
knitr::include_graphics("figrue/1.Metabolite.png")
```
...
```{r,eval=TRUE,echo=FALSE}
knitr::include_graphics("figrue/1.GeneExp.png")
```

<li>**Group Data**: Group information.

```{r,eval=TRUE,echo=FALSE,fig.align='left'}
knitr::include_graphics("figrue/1.GroupInfo.png")
```
...
```{r,eval=TRUE,echo=FALSE,fig.align='center'}
knitr::include_graphics("figrue/1.Nodesdata.png")
```

<li>**Edges Data**: Edges of subnetworks.

```{r,eval=TRUE,echo=FALSE,fig.align='center'}
knitr::include_graphics("figrue/1.Edegedata.png")
```
...
```{r,eval=TRUE,echo=FALSE,fig.align='center'}
knitr::include_graphics("figrue/subnetwork.png")
```
...
```{r,eval=TRUE,echo=FALSE,fig.align='center'}
knitr::include_graphics("figrue/2.ePEA.1.png")
```
...
```{r,eval=TRUE,echo=FALSE}
knitr::include_graphics("figrue/2.Metabolite-1.png")
```

<li>**Gene Data**: an interactive table for user-input metabolic data with rows corresponding to genes and columns correspond to the samples.

```{r,eval=TRUE,echo=FALSE}
knitr::include_graphics("figrue/2.GeneExp-1.png")
```

<li>**Group Data**: Group information.

```{r,eval=TRUE,echo=FALSE,fig.align='left'}
knitr::include_graphics("figrue/2.GroupInfo-1.png")
```
...
```{r,eval=TRUE,echo=FALSE,fig.align='center'}
knitr::include_graphics("figrue/2.ePEA-up.png")
```

<li>**Down ePEA Terms**: Down-regulated pathways.

```{r,eval=TRUE,echo=FALSE,fig.align='center'}
knitr::include_graphics("figrue/2.ePEA-down.png")
```

<li>**ePEA Plot**: Bar plot and dot plot illustrating enriched pathways are available, and can be downloaded as a PDF or JPEG file with specified width, height, and dpi settings.

```{r,eval=TRUE,echo=FALSE,fig.align='center'}
knitr::include_graphics("figrue/2.ePEA.png")
```
...
```{r,eval=TRUE,echo=FALSE,fig.align='center'}
knitr::include_graphics("figrue/2.ePDA.1.png")
```
...
```{r,eval=TRUE,echo=FALSE}
knitr::include_graphics("figrue/2.Metabolite-2.png")
```

<li>**Gene Data**: an interactive table for user-input metabolic data with rows corresponding to genes and columns correspond to the samples.

```{r,eval=TRUE,echo=FALSE}
knitr::include_graphics("figrue/2.GeneExp-2.png")
```

<li>**Group Data**: Group information.

```{r,eval=TRUE,echo=FALSE,fig.align='left'}
knitr::include_graphics("figrue/2.GroupInfo-2.png")
```
...
```{r,eval=TRUE,echo=FALSE,fig.align='center'}
knitr::include_graphics("figrue/2.ePDA-terms.png")
```
...
knitr::include_graphics("figrue/2.ePDA.png")
```
...
```{r,eval=TRUE,echo=FALSE,fig.align='center'}
knitr::include_graphics("figrue/2.eSEA.1.png")
```
...
```{r,eval=TRUE,echo=FALSE}
knitr::include_graphics("figrue/2.Metabolite-3.png")
```

<li>**Gene Data**: an interactive table for user-input metabolic data with rows corresponding to genes and columns correspond to the samples.

```{r,eval=TRUE,echo=FALSE}
knitr::include_graphics("figrue/2.GeneExp-3.png")
```

<li>**Group Data**: Group information.

```{r,eval=TRUE,echo=FALSE,fig.align='left'}
knitr::include_graphics("figrue/2.GroupInfo-3.png")
```
...
```{r,eval=TRUE,echo=FALSE,fig.align='center'}
knitr::include_graphics("figrue/2.eSEA-terms.png")
```
...
```{r,eval=TRUE,echo=FALSE,fig.align='center',out.width="70%"}
knitr::include_graphics("figrue/2.eSEA-2.png")
```
